const getInfo = () => {
 ...
 fetch('https://restcountries.eu/rest/v2/all?fields=name;languages;currencies;population;area;borders')
     .then(res => res.json())
     .then(data => {
         ...
         const showArea = () => {
          ...
          areaArr = areaArr.map( function(item) { return item == undefined ? null : item });
